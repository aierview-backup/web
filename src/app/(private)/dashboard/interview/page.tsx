...
export default function Interview() {
    ...
    const [selectedProgramingLanguage, setSelectedProgramingLanguage] = useState("");
    ...
    return (
        <div className={styles.content}>
            ...
            <div className={styles.cards}>
                <InterviewCard icon={<WhiteboardIcon/>} title="Whiteboard" percent={50} pending={100} complete={50}
                               total={100}/>
                <InterviewCard icon={<CodeReviewIcon/>} title="Code Review" percent={70} pending={30} complete={70}
                               total={100}/>
                <InterviewCard icon={<CodechallengeIcon/>} title="Code Challenge" percent={30} pending={70}
                               complete={30} total={100}/>
            </div>
            ...
            {isInterviewTypeModalOpen && (
                <Modal className={styles.modal} onClose={() => setIsInterviewTypeModalOpen(false)}>
            ...
            {isTechnologyModalOpen && (
                <Modal className={styles.modal} onClose={() => setIsTechnologyModal(false)}>
                    <form className={styles.form}>
                        <h1>{interviewType} mode activated</h1>
                        <p>Please provide the specialization, programming language, and seniority level to begin the
                            simulation.</p>
